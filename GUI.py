...
"")
        ...
        self.verticalSlider_3 = Slider(self.gridLayoutWidget_3)
        self.verticalSlider_3.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider_3.setObjectName("verticalSlider_3")
        self.gridLayout_3.addWidget(self.verticalSlider_3, 1, 2, 1, 1)
        self.verticalSlider = Slider(self.gridLayoutWidget_3)
        self.verticalSlider.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider.setObjectName("verticalSlider")
        self.gridLayout_3.addWidget(self.verticalSlider, 1, 3, 1, 1)
        self.verticalSlider_4 = Slider(self.gridLayoutWidget_3)
        self.verticalSlider_4.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider_4.setObjectName("verticalSlider_4")
        self.gridLayout_3.addWidget(self.verticalSlider_4, 1, 1, 1, 1)
        self.verticalSlider_5 = Slider(self.gridLayoutWidget_3)
        self.verticalSlider_5.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider_5.setObjectName("verticalSlider_5")
        self.gridLayout_3.addWidget(self.verticalSlider_5, 1, 4, 1, 1)
        self.verticalSlider_2 = Slider(self.gridLayoutWidget_3)
        self.verticalSlider_2.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider_2.setObjectName("verticalSlider_2")
        self.gridLayout_3.addWidget(self.verticalSlider_2, 1, 0, 1, 1)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_25.setText(_translate("MainWindow", "Gain:"))
        self.label_26.setText(_translate("MainWindow", "Gain:"))
