...
"")
        ...
        spacerItem = QtWidgets.QSpacerItem(600, 20, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
        self.PlayPauseVolumeGridLayout.addItem(spacerItem, 0, 5, 1, 1)
        self.SongSpectrogramGridLayout.addLayout(self.PlayPauseVolumeGridLayout, 2, 1, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(550, 20, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
        self.SongSpectrogramGridLayout.addItem(spacerItem1, 2, 3, 1, 1)
        self.SpectrogramGraphWidget = PlotWidget(self.gridLayoutWidget)
        self.SpectrogramGraphWidget.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.SpectrogramGraphWidget.setObjectName("SpectrogramGraphWidget")
        self.SongSpectrogramGridLayout.addWidget(self.SpectrogramGraphWidget, 1, 3, 1, 1)
        self.SongGraphWidget = PlotWidget(self.gridLayoutWidget)
        self.SongGraphWidget.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.SongGraphWidget.setObjectName("SongGraphWidget")
        self.SongSpectrogramGridLayout.addWidget(self.SongGraphWidget, 1, 1, 1, 1)
        spacerItem2 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.SongSpectrogramGridLayout.addItem(spacerItem2, 1, 2, 1, 1)
